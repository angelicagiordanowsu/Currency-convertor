...
def funct():
    ...
    class curr_main:
        ...
        def countries(self):
            req = requests.get(self.baseurl + "countries?apiKey=" +
                               self.apikey)
            return req.json()

        def currencies(self):
            req = requests.get(self.baseurl + "currencies?apiKey=" +
                               self.apikey)
            return req.json()
        ...
        def convert(self, curr_code):
            ...
            if req.json() == {}:
                print(
                    'No data found for the conversion, probably a wrong currency code!'
                )
